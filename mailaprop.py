...
def main():
    ...
    if include_header:
        print(";;; THIS FILE GENERATED WAS AUTOMATICALLY GENERATED BY:")
        print(";;; ")
        print(";;;   https://github.com/kfogel/mailaprop/")
        print(";;; ")
        print(";;; YOU PROBABLY DON'T WANT TO EDIT THIS FILE BY HAND.")
