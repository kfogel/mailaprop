...
all stored locally.  You shouldn't need to hand your social graph
over to billionaires just to get decent autofill behavior.
...
come up much faster (memo to programmers: mailaprop uses memoization).
